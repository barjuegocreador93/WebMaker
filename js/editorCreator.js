...
function selectObj(elem, name, num)
{
    $(elem).click(function ()
    {
        ...
        if (objArray[num].html === "input")
        {
            $('#html_text').hide();
            $('#html_attr_type').fadeIn();
            $('#html_attr_name').fadeIn();
        }
        else
        {
            $('#html_text').fadeIn();
...
$(document).ready(function () {
    ...
    $("#html_finish").click(function ()
    {
        ...
        var a = $("#html_attr_type input").val();
        $(select).attr("type",a);
    ...
    $("input[name='html_texter").click(function () {
        $(select).empty();
        $(select+":empty").css("border-color","grey");
    });
...
function objetosMK(html, etiquetas)
{
    $('#' + html).click(function ()
    {
        ...
        {
            if (etiquetas === null)
                $(select).append("<" + html + " class='wmob" + objets + "'></" + html + ">");
            else
                $(select).append("<" + html + " class='wmob" + objets + " '>");
            var a = new wmob();
